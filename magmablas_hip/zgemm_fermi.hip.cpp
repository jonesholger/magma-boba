    ...
    magma_queue_t queue )
{
    ...
    if ( TransA == 0 && TransB == 0 ) {
        ...
        hipLaunchKernelGGL(zgemm_kernel_fermi_nn, dim3(dimGrid), dim3(dimBlock), 0, queue->hip_stream() , 
        ...
        hipLaunchKernelGGL(zgemm_kernel_fermi_nt, dim3(dimGrid), dim3(dimBlock), 0, queue->hip_stream() , 
            m, n, k, dA, ldda, dB, lddb, dC, lddc, alpha, beta,
            (int)offsetA, (int)offsetB );
    }
        ...
        hipLaunchKernelGGL(zgemm_kernel_fermi_nc, dim3(dimGrid), dim3(dimBlock), 0, queue->hip_stream() , 
            m, n, k, dA, ldda, dB, lddb, dC, lddc, alpha, beta,
            (int)offsetA, (int)offsetB );
    }
        ...
        hipLaunchKernelGGL(zgemm_kernel_fermi_tn, dim3(dimGrid), dim3(dimBlock), 0, queue->hip_stream() , 
            m, n, k, dA, ldda, dB, lddb, dC, lddc, alpha, beta,
            (int)offsetA, (int)offsetB );
    }
        ...
        hipLaunchKernelGGL(zgemm_kernel_fermi_tt, dim3(dimGrid), dim3(dimBlock), 0, queue->hip_stream() , 
            m, n, k, dA, ldda, dB, lddb, dC, lddc, alpha, beta,
            (int)offsetA, (int)offsetB );
    }
        ...
        hipLaunchKernelGGL(zgemm_kernel_fermi_tc, dim3(dimGrid), dim3(dimBlock), 0, queue->hip_stream() , 
            m, n, k, dA, ldda, dB, lddb, dC, lddc, alpha, beta,
            (int)offsetA, (int)offsetB );
    }
        ...
        hipLaunchKernelGGL(zgemm_kernel_fermi_cn, dim3(dimGrid), dim3(dimBlock), 0, queue->hip_stream() , 
            m, n, k, dA, ldda, dB, lddb, dC, lddc, alpha, beta,
            (int)offsetA, (int)offsetB );
    }
        ...
        hipLaunchKernelGGL(zgemm_kernel_fermi_ct, dim3(dimGrid), dim3(dimBlock), 0, queue->hip_stream() , 
            m, n, k, dA, ldda, dB, lddb, dC, lddc, alpha, beta,
            (int)offsetA, (int)offsetB );
    }
        ...
        hipLaunchKernelGGL(zgemm_kernel_fermi_cc, dim3(dimGrid), dim3(dimBlock), 0, queue->hip_stream() , 
            m, n, k, dA, ldda, dB, lddb, dC, lddc, alpha, beta,
            (int)offsetA, (int)offsetB );
    }
