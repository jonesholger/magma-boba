...
// =============================================================================
        ...
        FloatingPoint_t tex_fetch(texture<int4> tex_ref, int coord)
        {
            ...
            return make_hipDoubleComplex(__hiloint2double(v.y, v.x), __hiloint2double(v.w, v.z));
            #else
            return make_hipDoubleComplex( 0., 0. );  // dummy code for 1.x compile
            #endif
        }
      #else
        static __device__
...
// =============================================================================
    ...
    #ifdef COMPLEX
      #ifdef DOUBLE
        texture<int4, hipTextureType1D, hipReadModeElementType> tex_ref_Amagma_z;
        texture<int4, hipTextureType1D, hipReadModeElementType> tex_ref_Bmagma_z;
      #else
        texture<float2, hipTextureType1D, hipReadModeElementType> tex_ref_Amagma_c;
        texture<float2, hipTextureType1D, hipReadModeElementType> tex_ref_Bmagma_c;
      #endif
    #else
      #ifdef DOUBLE
        texture<int2, hipTextureType1D, hipReadModeElementType> tex_ref_Amagma_d;
        texture<int2, hipTextureType1D, hipReadModeElementType> tex_ref_Bmagma_d;
      #else
        texture<float, hipTextureType1D, hipReadModeElementType> tex_ref_Amagma_s;
        texture<float, hipTextureType1D, hipReadModeElementType> tex_ref_Bmagma_s;
      #endif
    #endif
